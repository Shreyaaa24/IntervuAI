...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-[#F7F2FF] to-violet-100">
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <div className="inline-block">
              <div className="text-sm font-semibold text-violet-700 bg-violet-100 px-4 py-2 rounded-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Button
              ...
              className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:opacity-90 text-white rounded-full px-8"
            >
              Start Free Practice
            </Button>
            <Button
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <Card
              key={i}
              className="p-4 md:p-6 text-center border border-border/50 hover:border-violet-500 transition-colors"
            >
              <p className="font-semibold text-violet-700 text-sm md:text-base">
                {stat.label}
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-16">
          <div className="inline-block text-sm font-semibold text-violet-700 bg-violet-100 px-4 py-2 rounded-full mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {mockInterviewBenefits.map((item, index) => (
            <Card
              key={index}
              className="p-8 border border-border hover:border-violet-500/40 hover:shadow-md transition-all"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-violet-50/60 rounded-3xl">
        <div className="text-center mb-16">
          <div className="inline-block text-sm font-semibold text-violet-700 bg-violet-100 px-4 py-2 rounded-full mb-4">
            Under the Hood
          </div>
        ...
        {/* AI Flow Diagram */}
        <div className="mt-16 p-8 border border-violet-200 rounded-2xl bg-gradient-to-br from-violet-50 via-[#F7F2FF] to-violet-100">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-xl bg-violet-100 flex items-center justify-center text-xl mb-1">
                    {step.icon}
                  </div>
                ...
                {i < 5 && (
                  <div className="text-violet-700 text-lg font-light pb-5">→</div>
                )}
              </div>
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="p-8 border border-border hover:border-violet-500 hover:shadow-lg transition-all group"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Sample AI Feedback */}
          <Card className="p-6 border border-violet-300 bg-violet-50">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-24 h-2 bg-muted rounded-full overflow-hidden">
                    <div className="h-full w-4/5 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-full" />
                  </div>
                  <span className="text-sm font-bold text-violet-700">8/10</span>
                </div>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {domains.map((domain, index) => (
            <Card
              key={index}
              className="p-6 text-center border-2 border-border/50 hover:border-violet-500 hover:bg-violet-50 transition-all cursor-pointer group"
            >
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="relative">
              <div className="flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-white font-bold text-lg mb-4">
                  {item.step}
                </div>
          ...
          {faqs.map((faq, index) => (
            <Card key={index} className="border border-border overflow-hidden">
              ...
              >
                ...
                <span
                  className={`text-violet-700 text-xl flex-shrink-0 transition-transform duration-200 ${activeFaq === index ? "rotate-45" : ""}`}
                >
                  +
                </span>
              </button>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-gradient-to-r from-violet-100 via-fuchsia-50 to-indigo-100 rounded-2xl p-12 md:p-16 text-center border border-violet-200">
